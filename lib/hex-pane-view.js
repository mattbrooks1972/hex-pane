...
export default class HexPaneView {
	constructor(serializedState) {
		...
		this.address = document.createElement('pre');
		this.address.textContent = this.editor.getText();
		this.element.appendChild(this.address);

		this.hex = document.createElement('pre');
		this.hex.textContent = this.toHex(this.editor.getText());
		this.element.appendChild(this.hex);

		this.format = document.createElement('pre');
