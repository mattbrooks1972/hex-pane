...
export default class HexPaneView {
	constructor(serializedState) {
		...
		this.eol = atom.config.get('hex-pane.invisibles.eol');
		this.cr = atom.config.get('hex-pane.invisibles.cr');
		this.tab = atom.config.get('hex-pane.invisibles.tab');
		this.space = atom.config.get('hex-pane.invisibles.space');
